...
function squarpr(a,b){
    document.write(`<br> </br>`,a*b,`<br> </br>`)
}
squarpr(10,2)
// - створити функцію яка обчислює та повертає площу кола з радіусом r
document.write('Task 2')
function squarkolo(r){
    document.write(`<br> </br>`,3.14*(r**2),`<br> </br>`)
}
squarkolo(3)
// - створити функцію яка обчислює та повертає площу циліндру висотою h, та радіутом r
document.write('Task 3')
function squarculindr(r,h){
    document.write(`<br> </br>`,2*3.14*r*h+2*3.14*(r*r),`<br> </br>`)
}
squarculindr(5,2)
...
let array=["nvhj ",'kjbckj ','djkbcg ']
arrayEl(arr);
arrayEl(array)
// - створити функцію яка створює параграф з текстом. Текст задати через аргумент
document.write('Task 5')
function abzac(string){
